...
public class AttrAttrgroupRelationController {
    ...
    public Resp<String> deleteAttrByAttrIdAndGroupId(@RequestBody List<AttrAttrgroupRelationEntity> relationEntities){
        attrAttrgroupRelationService.deleteAttrByAttrIdAndGroupId(relationEntities);
        return Resp.ok("删除成功");
    }
    /**
     * 信息
